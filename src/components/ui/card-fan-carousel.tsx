...
const fanStyles = `
  ...
  @media (min-width: 480px) {
    ...
    .fan-card { width: 9rem; height: 12.5rem; }
  }
  @media (min-width: 640px) {
    .fan-layout { height: 28rem; }
    .fan-card { width: 10.5rem; height: 14.5rem; }
  }
  @media (min-width: 768px) {
    .fan-layout { height: 34rem; }
    .fan-card { width: 12rem; height: 17rem; }
  }
  @media (min-width: 1024px) {
    .fan-layout { height: 38rem; }
    .fan-card { width: 13rem; height: 18.5rem; }
  }
`;
          ...
          <div className="flex items-center justify-center gap-4 mt-4 md:mt-6 z-30">
            ...
            <div className="flex items-center gap-2">
              {cards.map((_, i) => (
                <span
                  key={i}
                  className={`w-2 h-2 rounded-full transition-all duration-300 ${i === centerIndex ? "bg-white/80 scale-[1.3]" : "bg-white/20"}`}
                />
              ))}
            </div>
            <button
